...
from backend.pyrankvote.helpers import CompareMethodIfEqual, ElectionManager, ElectionResults
...
def single_transferable_vote(
    ...
    votes_needed_to_win: float = math.floor(voters / float((seats + 1)))  # Drop quota
